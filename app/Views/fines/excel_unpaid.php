...
WHERE (fines.amount_paid IS NULL OR fines.amount_paid < fines.fine_amount)
...
while ($data = mysqli_fetch_assoc($result)) {
    ...
    $sheet->setCellValue("E$row", $data['amount_paid'] ?? 0);
...
// Download Excel
$filename = 'Laporan_Denda_Belum_Lunas_' . date('Y-m-d') . '.xlsx';
